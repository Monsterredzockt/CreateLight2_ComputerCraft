...
send(a1, 15) send(c2, 15) send(e2, 15) 
os.sleep(0.3) 
send(e2, 0) send(g2, 15) 
os.sleep(0.3) 
send(g2, 0) send(a2, 15) 
os.sleep(0.6) 
send(a2, 0) send(a1, 0) send(c2, 0) 
os.sleep(0.3)
send(a1, 15) send(c2, 15) send(e2, 15) 
os.sleep(0.3) 
send(e2, 0)
...
send(g2, 0) send(a2, 15) 
os.sleep(0.3) 
send(a2, 0) send(g2, 15) 
os.sleep(0.6) 
send(g2, 0) send(a1, 0) send(c2, 0) 
os.sleep(0.3)
send(c1, 15) send(e2, 15) send(d2, 15) 
os.sleep(0.3) 
send(d2, 0)
send(e2, 15) 
os.sleep(0.3) 
...
send(c1, 15) send(e2, 15) send(d2, 15) 
os.sleep(0.3) 
send(d2, 0) send(e2, 15) 
os.sleep(0.3) 
send(e2, 0) send(d2, 15) 
os.sleep(0.6) 
send(d2, 0) send(c1, 0) send(e2, 0) 
os.sleep(0.6) 
send(a1, 15) send(c2, 15) send(e2, 15) 
os.sleep(0.3) 
send(e2, 0) send(g2, 15) 
...
send(g2, 0) send(a1, 0) send(c2, 0) 
os.sleep(0.3)
send(f1, 15) send(a1, 15) send(d2, 15) 
os.sleep(0.3) 
send(d2, 0) send(e2, 15) 
os.sleep(0.3) 
send(e2, 0) send(g2, 15) 
os.sleep(0.6) 
send(g2, 0) send(f1, 0) send(a1, 0) 
os.sleep(0.3)
send(g1, 15) send(h1, 15) send(d2, 15) 
os.sleep(0.3) 
send(d2, 0) send(e2, 15) 
os.sleep(0.3) 
send(e2, 0) send(g2, 15) 
os.sleep(0.6) 
send(g2, 0) send(g1, 0) send(h1, 0) 
os.sleep(0.6)


send(a1, 15) send(c2, 15) send(e3, 15) 
os.sleep(0.3) 
send(e3, 0) send(g3, 15) 
os.sleep(0.3) 
send(g3, 0) send(a3, 15) 
os.sleep(0.6) 
send(a3, 0) send(a1, 0) send(c2, 0) 
os.sleep(0.3)
...
send(g3, 0) send(a3, 15) 
os.sleep(0.3) 
send(a3, 0) send(g3, 15) 
os.sleep(0.6) 
send(g3, 0) send(a1, 0) send(c2, 0) 
os.sleep(0.3)

send(c1, 15) send(e2, 15) send(d3, 15) 
os.sleep(0.3) 
send(d3, 0) send(e3, 15) 
os.sleep(0.3) 
send(e3, 0) send(g3, 15) 
os.sleep(0.6) 
send(g3, 0) send(c1, 0) send(e2, 0) 
os.sleep(0.3)
...
send(d3, 0) send(e3, 15) 
os.sleep(0.3) 
send(e3, 0) send(d3, 15) 
os.sleep(0.6) 
send(d3, 0) send(c1, 0) send(e2, 0) 
os.sleep(0.6)
